                    ...
                    <h1>Experience</h1>
                        <ul className='resume-list-containers'>
                            ...
                            <li>
                                ...
                                <p>
                                    ● Responded to medical emergencies to perform detailed medical
                                    examinations on patients and provided the necessary medical care and life
                                    saving procedures
                                </p>
                                <p>
                                    ● Controlled emergency scenes as both the scene lead and as a team member.
                                    This entailed communicating with, order
                                </p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p>
                                    ● Aided in mentoring, training, hiring and overseeing all duties of the staff to
                                    ensure each member’s success
                                </p>
                                <p>
                                    ● Promoted to Team Lead from being a volunteer the previous year. The
                                    present Team Leaders saw my potential and hired me as a new team lead
                                    the following year
                                </p>
                            </li>
                        </ul>
                    <h1>Education</h1>
                        <ul className='resume-list-containers'>
                            ...
                            <li>
                                ...
                                <h6>Extra-curriculars:</h6>
                                <p>● Peer Mentor</p>
                                <p className='second-bullet-point'>
                                    ○ Volunteered for the paramedic mentor program where I
                                    mentored a few students in the program to support them
                                    with the challenges of being a first responder
                                </p>
                                <p>
                                    ● Volunteer Student Representative
                                </p>
                                <p className='second-bullet-point'>
                                    ○ Voted in by my peers to be the Volunteer Student
                                    Representative for the Paramedic Program. I was in charge
                                    of communicating with my peers and my community to find,
                                    organize and run volunteer opportunities for the program.
                                </p>
                            </li>
                            <li>
